...
export const NewsCyclingCard: React.FC<NewsCyclingCardProps> = ({ source, articles }) => {
    ...
    return (
        <Card
            ...
            wrapperClassName={`group relative justify-between ${currentArticle.image_url ? 'min-h-[160px]' : ''}`}
            contentClassName="justify-between"
            action={articles.length > 1 ? (
        ...
        >
            <div className="flex w-full gap-2 items-start mb-2 relative shrink-0">
