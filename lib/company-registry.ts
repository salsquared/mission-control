 ...
 * Custom fetchers have moved to lib/companies/custom-fetchers.ts.
 * The COMPANY_REGISTRY array and helpers will move to lib/companies/registry.ts
 * in the next cleanup pass; for now this file remains the canonical source.
 */

import type { CompanyFeedConfig } from './fetchers/types';
import {
    fetchSpaceX, fetchOpenAI, fetchGroq, fetchCerebras, fetchMetaAI,
    TTL_STANDARD, TTL_LOW_VOLUME, TTL_VERY_LOW,
} from './companies/custom-fetchers';
